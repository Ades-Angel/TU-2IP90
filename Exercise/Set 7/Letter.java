...
09/10/2021
Prints a letter in a new window
*/
...
public class Letter extends JFrame {
    ...
    // at the top left of the screen, with newer Letters shifted farther to the
    // right
    ...
    // move dx pixels to the right and dy down; negative arguments move left resp.
    // up
    ...
    public void animate() {
        ...
        Letter.pauseInSec(0.5);
        x.setColor(Color.RED);
        this.moveRel(100, 50);

        Letter.pauseInSec(1.0);
        x.setColor(Color.ORANGE);
        this.moveRel(100, 50);

        Letter.pauseInSec(1.5);
        x.setColor(Color.YELLOW);
        this.moveRel(100, 50);

        Letter.pauseInSec(2.0);
        x.setColor(Color.GREEN);
        this.moveRel(100, 50);

        Letter.pauseInSec(2.5);
